...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Routes>
        <Route path={currTopic !== null ? `/articles/${currTopic}` : "/"} element={<ArticlesList  setIsHome={setIsHome} error={error} setError={setError} currTopic={currTopic} setCurrTopic={setCurrTopic} sortBy={sortBy} order={order}/>}></Route>
